...
! function (t, e, a) {
    var n = {
        widgetTitle: "",
        widgetStyle: 2,
        homePage: "https://www.studypdf.com/",
        numPosts: 10,
        summaryLength: 370,
        titleLength: "auto",
        thumbnailSize: 90,
        ...
        c = function (t) {
            ...
            if (r) {
                for (var h = 0; h < n.numPosts && h != c.length; h++) {
                    ...
                    m += 2 == d ? '<li><div class="random-post-item-thumbnail"><a href="' + e + '" title="' + a + '"' + u + '><img alt="' + a + '" data-src="' + l + '" width="' + n.thumbnailSize + '" height="' + n.thumbnailHeight + '" class="lazyload"></a></div><div class="random-post-item-title"><a title="' + a + '" href="' + e + '"' + u + ">" + i + '</a></div><span class="random-post-item-summary"><span class="random-post-item-summary-text">' + s + '</span> <a href="' + e + '" class="random-post-item-more"' + u + ">" + n.moreText + "</a></span>" + p + "</li>" : 3 == d || 4 == d ? '<li class="random-post-item" tabindex="0"><a class="random-post-item-title" href="' + e + '"' + u + ' target="_blank"><img alt="' + a + '" class="random-post-item-thumbnail" data-src="' + l + '" width="' + n.thumbnailSize + '" height="' + n.thumbnailSize + '" class="lazyload"></a><div class="random-post-item-tooltip"><a class="random-post-item-title" title="' + a + '" href="' + e + '"' + u + " target='_blank'>" + i + "</a></div>" + p + "</li>" : 5 == d ? '<li class="random-post-item" tabindex="0"><a class="random-post-item-wrapper" href="' + e + '" title="' + a + '"' + u + ' target="_blank"><img alt="' + a + '" class="random-post-item-thumbnail" data-src="' + l + '" width="' + n.thumbnailSize + '" height="' + n.thumbnailSize + '" class="lazyload"><span class="random-post-item-tooltip">' + i + "</span></a>" + p + "</li>" : 6 == d ? '<li><a class="random-post-item-title" title="' + a + '" href="' + e + '"' + u + " target='_blank'>" + i + '</a><div class="random-post-item-tooltip"><img alt="' + a + '" class="random-post-item-thumbnail" data-src="' + l + '" width="' + n.thumbnailSize + '" height="' + n.thumbnailSize + '" class="lazyload"><span class="random-post-item-summary"><span class="random-post-item-summary-text">' + s + "</span></span>" + p + "</div></li>" : '<li><a title="' + a + '" href="' + e + '"' + u + " target='_blank'>" + i + "</a></li>"
                }
        ...
        d = function (t) {
            ...
            if (r) {
                for (var h = 0; h < n.numPosts && h != c.length; h++) {
                    ...
                    for (var f = 0, g = c[h].link.length; g > f; f++) e = "alternate" == c[h].link[f].rel ? c[h].link[f].href : "#";
                    m += 2 == d ? '<li><a href="' + e + '" title="' + a + '"' + u + '><div class="related-post-item-thumbnail"><img alt="' + a + '" class="related-post-item-thumbnail lazyload" data-src="' + l + '" width="16" height="9"></div></a><a class="related-post-item-title" title="' + a + '" href="' + e + '"' + u + ">" + i + '</a><span class="related-post-item-summary"><span class="related-post-item-summary-text">' + s + '</span> <a href="' + e + '" class="related-post-item-more"' + u + ">" + n.moreText + "</a></span>" + p + "</li>" : 3 == d || 4 == d ? '<li class="related-post-item" tabindex="0"><a class="related-post-item-title" href="' + e + '"' + u + ' target="_blank"><img alt="' + a + '" class="related-post-item-thumbnail lazyload" data-src="' + l + '" width="' + n.thumbnailSize + '" height="' + n.thumbnailSize + '"></a><div class="related-post-item-tooltip"><a class="related-post-item-title" title="' + a + '" href="' + e + '"' + u + " target='_blank'>" + i + "</a></div>" + p + "</li>" : 5 == d ? '<li class="related-post-item" tabindex="0"><a class="related-post-item-wrapper" href="' + e + '" title="' + a + '"' + u + ' target="_blank"><img alt="' + a + '" class="related-post-item-thumbnail lazyload" data-src="' + l + '" width="' + n.thumbnailSize + '" height="' + n.thumbnailSize + '"><span class="related-post-item-tooltip">' + i + "</span></a>" + p + "</li>" : 6 == d ? '<li><a class="related-post-item-title" title="' + a + '" href="' + e + '"' + u + " target='_blank'>" + i + '</a><div class="related-post-item-tooltip"><img alt="' + a + '" class="related-post-item-thumbnail lazyload" data-src="' + l + '" width="' + n.thumbnailSize + '" height="' + n.thumbnailSize + '"><span class="related-post-item-summary"><span class="related-post-item-summary-text">' + s + "</span></span>" + p + "</div></li>" : '<li><a title="' + a + '" href="' + e + '"' + u + " target='_blank'>" + i + "</a></li>"
                }
                r.innerHTML = m += "</ul>" + p, n.callBack()
            }
        };
        ...
        L = function () {
            var s, m, u, h, f, E, L, N, P, _, I, M, R = /^img$/i,
                ...
                Z = T(function (t, e, a, i, l) {
                    var s, o, c, m, h, f;
                    (h = z(t, "lazybeforeunveil", e)).defaultPrevented || (i && (a ? b(t, n.autosizesClass) : t.setAttribute("sizes", i)), o = t[r](n.srcsetAttr), s = t[r](n.srcAttr).replace("https://blogger.googleusercontent.com/", "https://www.studypdf.com/"), l && (c = t.parentNode, m = c && p.test(c.nodeName || "")), f = e.firesLoad || "src" in t && (o || s || m), h = {
                        target: t
